...
const WebApplication = () => {
    return (
        <section className='max-w-[1720px] mx-auto '>
            ...
            <div className= 'relative px-6 md:px-16 pb-10 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 bg-[#24204E]  items-center justify-center   '>
                <div className='relative flex justify-center items-center'>
                    <div className=' absolute  bg-[#3A3570] rounded-full top-20 xl:left-[-100pxpx] xl:w-[450px] xl:h-[450px] w-[300px] h-[300px] md:w-[350px] md:h-[350px] '></div>
                ...
                <div className='flex flex-col gap-3 justify-center items-center text-center md:text-left xl:items-start  leading-9 tracking-wide '>
                    <h1 className='text-3xl md:text-4xl xl:text-5xl text-white font-bold '>Web Application</h1>
                    <p className='text-[#CCD2D9] xl:text-left text-center text-lg  max-w-[600px] '>Crypto apps are mobile or web applications designed to facilitate various activities related to cryptocurrencies. These apps allow users to buy, sell, trade, and manage their digital assets securely. Features often include real-time price tracking.</p>
