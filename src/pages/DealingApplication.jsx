...
const DealingApplication = () => {
  return (
     <section className='max-w-[1720px] mx-auto '>
              ...
              <div className= 'relative px-6 md:px-16  grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 bg-gradient-to-b from-[#8942C6] to-[#562176]  items-center justify-center py-7  '>
                <div className='order-2 pb-10 xl:mt-0 mt-14 xl:order-1 grid-2 flex flex-col gap-3 justify-center items-center text-center xl:text-left xl:items-start  leading-9 tracking-wide xl:ml-20  '>
                      <h1 className='text-3xl md:text-4xl xl:text-5xl text-white font-bold mb-3 '>Dealing Application</h1>
                      ...
                      <button className='flex gap-2 xl:mt-10 items-center cursor-pointer text-[15px] font-semibold text-white'>
                          View Our Project <span className='w-6 h-6 transition-all duration-150  hover:translate-x-3'><img src={arrow} className='object-contain w-full h-full'/></span>
                      </button>
                  </div>
                  <div className='order-1 xl:order-2 relative flex justify-center items-center'>
                     <div className=' absolute  bg-[#FFFFFF]/10  rounded-full top-18 xl:left-[-100pxpx]  w-[350px] h-[350px] md:w-[400px] md:h-[400px] '></div>
                    <div className=' absolute  bg-[#FFFFFF]/20 bg-opacity-[10%] rounded-full top-25 xl:left-[-100pxpx]  w-[300px] h-[300px] md:w-[350px] md:h-[350px] '></div>
                      <div className=' absolute  bg-[#FFFFFF]/30  rounded-full top-30 xl:left-[-100pxpx] w-[250px] h-[250px] md:w-[300px] md:h-[300px] '></div>
