...
const Hero = () => {
  return (
    <section className="relative w-full max-w-[1720px] mx-auto h-[500px] ">
      ...
      />
      <div className="absolute inset-0 bg-[#2C3D9B]/90"></div>


     <div className="relative flex flex-col xl:flex-row justify-between items-center xl:items-start px-6 xl:px-30">

        <div className="text-[#FFFFFF] xl:pb-30 pt-20   ">
          <h1 className="xl:text-4xl max-w-[500px] text-2xl font-bold leading-tight">
            <span className="font-[300]">  Experience A World-Class</span> <br />
            Mobile App Development Service
          </h1>

          <p className="mt-6 xl:text-2xl max-w-[480px] text-[#FFFFFF]">
        ...
        <div className="bg-[#FFFFFF] xl:w-[600px] md:w-[450px] xl:ml-20 p-10 rounded-xl  xl:translate-y-15 translate-y-20">
          <h2 className="md:text-2xl xl:text-3xl text-center font-[500] mb-6">
          ...
          <form className="flex flex-col gap-10">
            ...
            <textarea
              ...
              className="border-b resize-none border-gray-400 py-2 placeholder-gray-400 placeholder:font-semibold outline-none" />
